...
library ZoraDeployerUtils {
    ...
    bytes32 constant FACTORY_DEPLOYER_DEPLOYMENT_SALT = bytes32(0x0000000000000000000000000000000000000000668d7f9ed18e35000dbaba00);
    ...
    function deployNewPreminterImplementationDeterminstic(address factoryProxyAddress) internal returns (address) {
        ...
        bytes32 salt = bytes32(0x0000000000000000000000000000000000000000668d7f9ec18e35000dbaba0d);
